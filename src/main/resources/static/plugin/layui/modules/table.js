...
layui.define(['laytpl', 'laypage', 'layer', 'form', 'util'], function(exports){
  ...
  table.selectAll = function (e) {
    var t = 0, i = 0, a = [], l = table.cache[e] || [];
    layui.each(l, function (e, l) {
      return l.constructor === Array ? void i++ : void ((t++, a.push(table.clearCacheKey(l))))
    });
    return a;
  };
